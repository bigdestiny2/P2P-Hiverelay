...
- [x] **4.114** Current ship handoff evidence refresh — the 2026-06-26 handoff now reflects current `main` at PR #141, including fresh post-merge Test and Docker workflow IDs, ecosystem-consumer parity gates, the StartOS release-image blocker, and the newest current-main release-distribution preflight failure after the appliance release-readiness merge.
...
Current masked-value preflight evidence: GitHub Actions run `28292692235` fails
