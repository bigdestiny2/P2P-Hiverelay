...
function verifyPrereleaseSkips (release) {
  ...
  requireOneOf(
    ...
    release.surfaces?.npmPackages,
    release.release?.candidate ? ['skipped'] : ['published-next', 'current-next']
  )
  ...
  requireOneOf('prerelease Umbrel community validation', release.surfaces?.umbrelCommunityStore?.validation, ['skipped'])
  requireOneOf('prerelease Umbrel community publish', release.surfaces?.umbrelCommunityStore?.publish, ['skipped'])
