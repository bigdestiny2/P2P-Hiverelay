...
const currentShipHandoffRequiredTerms = [
  ...
  'HEAD inspected: `5934dbc`',
  'Commit subject: `feat: harden appliance release readiness`',
  'Worktree: clean snapshot (`main@5934dbc`)',
  'PR #141 CI finished green',
  'Post-merge main Test run: `28292603571`',
  'Post-merge Docker snapshot publish: `28292603573`',
  'Release distribution preflight run: `28292692235` (issue #120)',
  'Run URL: https://github.com/bigdestiny2/P2P-Hiverelay/actions/runs/28292692235',
  'Latest checked preflight: state `completed/failure`, head `main@5934dbc`, created `2026-06-27T14:55:58Z`',
