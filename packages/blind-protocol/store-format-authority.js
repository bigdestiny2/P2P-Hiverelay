...
export const STORE_FORMAT_AUTHORITY_V1 = Object.freeze([
  entry('artifact.encoding', 'magic[8]=ASCII(HRBSFA01) || authorityVersion:u16be=1 || formatMajor:u16be=1 || formatMinor:u16be=1 || schemaCatalogLength:u64be || exact schemaCatalog bytes || entryCount:u16be || sorted entries(nameLength:u16be || printable ASCII name || valueLength:u32be || printable ASCII value)'),
