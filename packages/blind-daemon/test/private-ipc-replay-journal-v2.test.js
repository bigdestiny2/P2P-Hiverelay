...
test('V2 replay journal bootstraps one exact private format and exposes only opaque capabilities', async t => {
  ...
  t.is(PRIVATE_IPC_REPLAY_JOURNAL_V2_INTEGRATION_STATUS.serverWired, true)
  t.is(PRIVATE_IPC_REPLAY_JOURNAL_V2_INTEGRATION_STATUS.assemblerWired, true)
  t.is(PRIVATE_IPC_REPLAY_JOURNAL_V2_INTEGRATION_STATUS.productionRuntimeWired, false)
  t.is(PRIVATE_IPC_REPLAY_JOURNAL_V2_INTEGRATION_STATUS.productionEntrypointWired, false)
  t.is(PRIVATE_IPC_REPLAY_JOURNAL_V2_INTEGRATION_STATUS.externalBootGenerationFenceRequired, false)
  t.is(PRIVATE_IPC_REPLAY_JOURNAL_V2_INTEGRATION_STATUS.blocker,
    'PRODUCTION_ENTRYPOINT_CELL_ADMISSION_ASSEMBLY_UNWIRED')
  t.alike(PRIVATE_IPC_REPLAY_JOURNAL_V2_INTEGRATION_STATUS.blockers, [
    'PRODUCTION_ENTRYPOINT_CELL_ADMISSION_ASSEMBLY_UNWIRED',
