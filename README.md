...
**Open source (Apache 2.0)** | **[GitHub](https://github.com/bigdestiny2/P2P-Hiverelay)** | **[npm](https://www.npmjs.com/package/p2p-hiverelay)** | **Status: v0.20.1**
...
|---|---|---|
| Core3 packages | Monorepo and package manifests are aligned at `v0.20.1` | A tag/release must run `npm run release:prepare` so versions, fleet channels, Umbrel, and StartOS metadata move together |
...
| `npm run release:check-github-setup` | Verify the repo exposes the release secret/variable names before tagging |
